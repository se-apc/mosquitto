...
static int sub__add_normal(struct mosquitto_db *db, struct mosquitto *context, int qos, uint32_t identifier, int options, struct mosquitto__subhier *subhier, FUNC_broker_plugin_sub_on_send on_send, void* plugin_context)
{
...
static int sub__add_context(struct mosquitto_db *db, struct mosquitto *context, int qos, uint32_t identifier, int options, struct mosquitto__subhier *subhier, struct sub__token *tokens, char *sharename, FUNC_broker_plugin_sub_on_send on_send, void* plugin_context)
{
...
int sub__add_plugin(struct mosquitto_db *db, struct mosquitto *context, const char *sub, int qos, uint32_t identifier, int options, struct mosquitto__subhier **root, FUNC_broker_plugin_sub_on_send on_send, void* plugin_context)
{
	int rc = 0;
...
static int retain__process(struct mosquitto_db *db, struct mosquitto__subhier *branch, struct mosquitto *context, int sub_qos, uint32_t subscription_identifier, time_t now, FUNC_broker_plugin_sub_on_send on_send, void* plugin_context)
{
	int rc = 0;
	int qos;
	uint16_t mid;
...
static int retain__search(struct mosquitto_db *db, struct mosquitto__subhier *subhier, struct sub__token *tokens, struct mosquitto *context, const char *sub, int sub_qos, uint32_t subscription_identifier, time_t now, int level, FUNC_broker_plugin_sub_on_send on_send, void* plugin_context)
{
	struct mosquitto__subhier *branch, *branch_tmp;
	int flag = 0;
...
int sub__retain_queue_plugin(struct mosquitto_db *db, struct mosquitto *context, const char *sub, int sub_qos, uint32_t subscription_identifier, FUNC_broker_plugin_sub_on_send on_send, void* plugin_context)
{
	struct mosquitto__subhier *subhier;
